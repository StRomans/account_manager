...
import { FilterRuleComponent } from 'app/entities/filter-rule/filter-rule.component';
...
describe('Component Tests', () => {
  describe('FilterRule Management Component', () => {
    let comp: FilterRuleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FilterRuleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.filterRules && comp.filterRules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
