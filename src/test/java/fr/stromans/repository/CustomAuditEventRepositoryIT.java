...
import fr.stromans.config.audit.AuditEventConverter;
import fr.stromans.domain.PersistentAuditEvent;
...
import static fr.stromans.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
